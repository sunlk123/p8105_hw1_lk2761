...
This code chunk uses **as.numeric** to convert the logical, character and factor variables from the sample_df data frame to numeric variables.The code chunk is shown but the output is not.  
